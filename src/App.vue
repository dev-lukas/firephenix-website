...
<template>
  <div class="app">
    <canvas v-if="!isBannerGmodRoute" id="bg-canvas"></canvas>
    <NavBar v-if="!isBannerGmodRoute" />
...
const isBannerGmodRoute = computed(() => route.path === '/banner/gmod');

onMounted(() => {
  if (!isBannerGmodRoute.value) {
