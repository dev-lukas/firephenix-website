...
<template>
            ...
            <div class="login-section">
                <div class="steam-login-box glow-effect">
                    ...
                    <div class="steam-logo">
                        <img src="../assets/images/other/steam.png" alt="Steam Logo" class="steam-logo-img">
                    </div>
                ...
                <div class="benefits-section">
                 ...
                 <footer class="steam-footer">
                    <div class="footer-content">
                        © 2025 Valve Corporation. Steam und das Steam-Logo sind Marken und/oder eingetragene Marken von Valve Corporation in den USA und/oder anderen Ländern.
                    </div>
                </footer>
            </div>
  </template>
    ...
    data() {
      return {
        benefits: [
        {
            icon: 'fas fa-trophy',
            title: 'Zeit Sync',
            description: 'Synchronisiere deine Onlinezeit und Level zwischen Discord und TeamSpeak'
          },
        {
            icon: 'fas fa-users',
            title: 'Permanente Channel',
            description: 'Erstelle deinen eigenen permanenten Channel auf den Voice-Servern'
        },
        {
            icon: 'fas fa-trophy',
            title: 'Cosmetics',
            description: 'Erhalte exklusive Kosmetik in TTT und auf anderen FirePhenix Game-Servern'
        }
        ]
      }
    },
  ...
  .login-page {
    min-height: 100vh;
    background: linear-gradient(135deg, var(--clr-background) 0%, var(--clr-background-dark) 100%);
    padding: 80px 20px 0;
...
.steam-logo, .steam-login-button, .login-disclaimer {
  position: relative;
  z-index: 2;
}
