...
<template>
  <base-legal-page title="Datenschutzerklärung" last-updated="23.05.2025">
    ...
    <p>
      ...
      dieser Website erfasst werden, werden auf den Servern des Hosters bzw. der
    ...
    <p>
      ...
      ein: Hetzner Online GmbH. Die Server befinden sich innerhalb der EU,
      hauptsächlich in Deutschland und Finnland.
    </p>
    ...
    <section class="privacy-section">
      ...
      <p>
        ...
        sich über Steam einloggen, werden wir zur Authentifizierung zu Steam
      ...
      <p>
        ...
        Datenschutzerklärung von Valve:
        <a
    ...
    <section class="privacy-section">
      ...
      <ul>
        <li>
          <strong>Recht auf Auskunft (Art. 15 DSGVO):</strong> Sie können Auskunft
        ...
        <li>
          ...
          Sie können die Einschränkung der Verarbeitung Ihrer personenbezogenen
          Daten verlangen.
        </li>
        <li>
          <strong>Recht auf Datenübertragbarkeit (Art. 20 DSGVO):</strong> Sie
          können verlangen, Ihre personenbezogenen Daten, die Sie uns bereitgestellt
